...
const BlogCard = ({
  ...
  return (
    ...
    // </div>
    <div
      className="blog-item-style-three group relative overflow-hidden rounded-2xl bg-gradient-to-b from-gray-900 to-black border border-gray-700 transition-all duration-500 hover:border-secondary-500 hover:shadow-2xl hover:shadow-secondary-500/20"
      {...(aos ? aosProps : {})}
    >
